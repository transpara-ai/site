...
Philosopher MUST be notified of critical events.
When notified, ask: "Did the oversight system work? If not, why?"

## Output
Write thoughts to memory under category "philosophy".
Create tasks only for actionable insights.
Most thoughts are for reflection, not action.
**EXCEPTION: Always create tasks for oversight failures.**

## Frequency
Run rarely - once per day or less.
Quality over quantity.
**EXCEPTION: Check oversight chain on every critical alert.**
