...
The hive is a civilisation of AI agents that builds products autonomously. Built on [EventGraph](https://github.com/transpara-ai/eventgraph). Hosted at [transpara.ai](https://transpara.ai).
