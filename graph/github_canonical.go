...
func buildOpsGitHubCanonicalData(now time.Time) *OpsGitHubCanonicalData {
	lanes := []OpsGitHubCanonicalLane{
		...
		githubCanonicalLane("transpara-ai/site", 129, "Typed projection-backed GitHub-canonical monitor", "https://github.com/transpara-ai/site/issues/129", "docs#197", "Site ops monitor and typed projection-shaped migration evidence view", githubCanonicalStateCompleted, "merged by PR #130; refreshed by site#131", "protected-action", "", []string{"cc:intake", "cc:protected-action", "cc:civilization-presence"}, []string{"docs#197", "eventgraph#63", "https://github.com/transpara-ai/site/pull/130", "merge:cf3dcddbb06d47199dd7c94662e329422d27d10c", "site#131"}, nil),
	...
	return &OpsGitHubCanonicalData{
		...
		CutoverChecks: []OpsGitHubCanonicalCutoverCheck{
			{Label: "Issue coverage", State: "partial", Evidence: "docs#197 and child issue lanes exist; scanner:2026-06-26T02:53:48Z found no multi-issue bundles", Blocker: "remaining EventGraph/docs/operation protected lanes open"},
			...
			{Label: "Site typed monitor", State: "completed", Evidence: "site#129 merged by PR #130; site#131 refresh in progress", Blocker: ""},
	...
	return []OpsGitHubCanonicalEvidenceRecord{
		{
			...
			Outcome:                 "tests.pass",
			Schema:                  "TestRun",
			SourceIssueRefs:         []string{"docs#197", "site#129", "site#131", "eventgraph#63"},
			PRRefs:                  []string{"eventgraph PR #67", "site PR #130"},
		...
		},
		{
			...
			Schema:                "GateResult",
			SourceIssueRefs:       []string{"docs#197", "work#61", "work#62", "work#63", "site#127", "site#129", "platform#5", ".github#3", "eventgraph#63", "eventgraph#62", "hive#220", "hive#221", "hive#222", "hive#223"},
			PRRefs:                []string{"https://github.com/transpara-ai/work/pull/71", "https://github.com/transpara-ai/work/pull/72", "https://github.com/transpara-ai/work/pull/73", "https://github.com/transpara-ai/site/pull/128", "https://github.com/transpara-ai/site/pull/130", "https://github.com/transpara-ai/platform/pull/8", "https://github.com/transpara-ai/.github/pull/4", "https://github.com/transpara-ai/eventgraph/pull/67", "https://github.com/transpara-ai/eventgraph/pull/68", "https://github.com/transpara-ai/hive/pull/228", "https://github.com/transpara-ai/hive/pull/229", "https://github.com/transpara-ai/hive/pull/230", "https://github.com/transpara-ai/hive/pull/231"},
			ValidationRefs:        []string{"change-control scan: no multi-issue bundles", "arc_issue_scan: Findings=0"},
			CFARRefs:              []string{"work PR #71/#72/#73 CFAR PASS", "site PR #128/#130 CFAR PASS", "platform PR #8 CFAR PASS", ".github PR #4 CFAR PASS", "eventgraph PR #67/#68 CFAR PASS", "hive PR #228/#229/#230/#231 CFAR PASS"},
			...
			ProjectionReadinessNote: "8300 bp is a display confidence score for the cited source-of-intent substrate; EventGraph projection-store/write lanes remain open",
		},
		{
			...
			Schema:                  "AuditReport",
			SourceIssueRefs:         []string{"docs#197", "site#129", "site#131"},
			PRRefs:                  []string{"pending"},
			ValidationRefs:          []string{"site#130 validation complete", "pending site#131 validation", "pending final docs closeout scan"},
			CFARRefs:                []string{"site PR #130 CFAR PASS", "pending site#131 CFAR", "pending final docs closeout CFAR"},
			AuthorityBoundaryRefs:   []string{"eventgraph#59", "eventgraph#61", "docs#200"},
			ResidualRiskRefs:        []string{"docs#201", "docs#202", "docs#203"},
			ProvenanceRefs:          []string{"https://github.com/transpara-ai/site/issues/129", "https://github.com/transpara-ai/site/issues/131", "https://github.com/transpara-ai/docs/issues/197", "pending final docs closeout PR"},
