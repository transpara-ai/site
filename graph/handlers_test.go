...
func TestHandleOpsCivilizationConsumesHiveProjection(t *testing.T) {
	...
	for _, want := range []string{
		...
		`data-civilization-wide-table="factory-orders"><table class="min-w-[72rem]`,
		`data-civilization-wide-table="work-tasks"><table class="min-w-[96rem]`,
		`data-civilization-wide-table="work-artifacts"><table class="min-w-[64rem]`,
		`data-civilization-wide-table="issue-scan-stage-evidence"><table class="min-w-[64rem]`,
		`data-civilization-wide-table="role-topology"><table class="min-w-[84rem]`,
		`min-w-[96rem]`,
		`min-w-[84rem]`,
		"test_run_001",
		"gate_result_001",
