...
func buildOpsGitHubCanonicalData(now time.Time) *OpsGitHubCanonicalData {
	lanes := []OpsGitHubCanonicalLane{
		...
		githubCanonicalLane("transpara-ai/platform", 7, "Stage 2 and Stage 3 plumbing automation with model-family separation", "https://github.com/transpara-ai/platform/issues/7", "docs#197", "platform Stage 2/3 design boundary and model-family separation", githubCanonicalStateCompleted, "closed by platform PR #19; future implementation remains follow-on issue/AuthorityDecision scoped", "protected-action", "", []string{"cc:intake", "cc:pr-deferred", "cc:protected-action", "cc:civilization-presence", "cc:needs-human-scope"}, []string{"platform#7", "https://github.com/transpara-ai/platform/pull/19", "merge:e6691b62c4fd98179441f0085f23ab1c7c9a2f52", "reviewed_head:488bf95db116c0555757c7781173fd41923599e2", "https://github.com/transpara-ai/platform/pull/19#issuecomment-4809397170", "https://github.com/transpara-ai/docs/issues/197#issuecomment-4809411010"}, nil),
	...
	return &OpsGitHubCanonicalData{
		...
		CutoverChecks: []OpsGitHubCanonicalCutoverCheck{
			...
			{Label: "Site typed monitor", State: "completed", Evidence: "site#129 merged by PR #130; site#131/site#133/site#135/site#139 merged; site#143 refresh records docs#199 completion; latest refresh records platform#7 closeout evidence", Blocker: ""},
