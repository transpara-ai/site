...
func buildOpsGitHubCanonicalData(now time.Time) *OpsGitHubCanonicalData {
	lanes := []OpsGitHubCanonicalLane{
		...
		githubCanonicalLane("transpara-ai/site", 129, "Typed projection-backed GitHub-canonical monitor", "https://github.com/transpara-ai/site/issues/129", "docs#197", "Site ops monitor and typed projection-shaped migration evidence view", githubCanonicalStateCompleted, "merged by PR #130; refreshed by site#131, site#133, site#135, site#139, site#143, and site#145", "protected-action", "", []string{"cc:intake", "cc:protected-action", "cc:civilization-presence"}, []string{"docs#197", "docs#199", "eventgraph#63", "eventgraph#69", "hive#232", "https://github.com/transpara-ai/site/pull/130", "https://github.com/transpara-ai/site/pull/132", "https://github.com/transpara-ai/site/pull/144", "merge:cf3dcddbb06d47199dd7c94662e329422d27d10c", "merge:c3dc3a63eb16eafed490b7e6be28affe3469f7ea", "merge:885d8f14fbcf15c6d5ae1b67d88a3f40a7d9104d", "site#131", "site#133", "site#135", "site#139", "site#143", "site#145"}, nil),
	...
	return &OpsGitHubCanonicalData{
		...
		CutoverChecks: []OpsGitHubCanonicalCutoverCheck{
			{Label: "Issue coverage", State: "partial", Evidence: "docs#197 and child issue lanes exist; scanner:2026-06-26T09:20:29Z found no PR-ready issues, no autonomous PR-ready issues, no candidate bundles, and no issue-shape warnings after docs#199 closed", Blocker: "remaining protected lanes are human-scope"},
			...
			{Label: "Autonomy frontier", State: githubCanonicalStateCompleted, Evidence: "platform#17 merged by PR #18; post-docs#199 autonomy_frontier remains park-autonomy-no-pr-ready-work with zero PR-ready, autonomous PR-ready, candidate-bundle, and issue-shape-warning counts", Blocker: ""},
			...
			{Label: "Site typed monitor", State: "completed", Evidence: "site#129 merged by PR #130; site#131/site#133/site#135/site#139 merged; site#143 refresh records docs#199 completion", Blocker: ""},
...
func githubCanonicalAutonomyFrontier() OpsGitHubCanonicalAutonomyFrontier {
	return OpsGitHubCanonicalAutonomyFrontier{
		...
		EvidenceRefs: []string{
			...
			"scanner:2026-06-26T09:20:29Z issue_shape_warning_count:0",
	...
	return []OpsGitHubCanonicalEvidenceRecord{
		{
			...
			PRRefs:                  []string{"docs PR #205", "eventgraph PR #67", "eventgraph PR #70", "hive PR #233", "site PR #130", "site PR #132", "site PR #144", "platform PR #16", "platform PR #18"},
			ValidationRefs:          []string{"go test ./pkg/event -run TestNativeEvidence -count=1", "make verify-go", "make verify", "site#143 validation complete", "platform scanner grouping comparison identical", "platform scanner issue_shape_warnings=[]", "platform scanner autonomy_frontier recommendation=park-autonomy-no-pr-ready-work"},
			CFARRefs:                []string{"docs PR #205 CFAR PASS", "eventgraph PR #67/#70 CFAR PASS", "hive PR #233 CFAR PASS", "site PR #132/#144 CFAR PASS", "platform PR #16/#18 CFAR PASS"},
			AuthorityBoundaryRefs:   []string{"docs#197", "docs#199", "eventgraph#61", "docs#200"},
			ResidualRiskRefs:        []string{"docs#201", "docs#202", "docs#203"},
			ProvenanceRefs:          []string{"https://github.com/transpara-ai/docs/pull/205", "https://github.com/transpara-ai/eventgraph/pull/67", "https://github.com/transpara-ai/eventgraph/pull/70", "https://github.com/transpara-ai/hive/pull/233", "https://github.com/transpara-ai/site/pull/132", "https://github.com/transpara-ai/site/pull/144", "https://github.com/transpara-ai/platform/pull/16", "https://github.com/transpara-ai/platform/pull/18", "merge:874980a7ab6d1b5c6ef3bacfc8c02f1401f00a13", "reviewed_head:2c76e779e51b004db4004f81117cfcb6dd3e3638", "merge:c6f261a27a193a470a9e287d15580a05d1b0fafc", "merge:ec22be652d0f117c68393104ad911042fc5cc272", "merge:89921d82d5019f2181e2b75435019c19e9ab92c9", "merge:c3dc3a63eb16eafed490b7e6be28affe3469f7ea", "merge:885d8f14fbcf15c6d5ae1b67d88a3f40a7d9104d", "merge:c9b27259feceb4a7e4113afbbf36364cc84cde9d", "merge:b4ba2f98254ff32360dfcb490eb86e4613d8999d", "https://github.com/transpara-ai/docs/pull/205#issuecomment-4808081439", "https://github.com/transpara-ai/eventgraph/pull/67#issuecomment-4803740786", "https://github.com/transpara-ai/eventgraph/pull/70#issuecomment-4806223812", "https://github.com/transpara-ai/hive/pull/233#issuecomment-4806413483", "https://github.com/transpara-ai/site/pull/144#issuecomment-4808318161", "https://github.com/transpara-ai/platform/pull/16#issuecomment-4806876411", "https://github.com/transpara-ai/platform/pull/18#issuecomment-4807330168"},
		...
		},
		{
			...
			PRRefs:                []string{"https://github.com/transpara-ai/docs/pull/205", "https://github.com/transpara-ai/work/pull/71", "https://github.com/transpara-ai/work/pull/72", "https://github.com/transpara-ai/work/pull/73", "https://github.com/transpara-ai/site/pull/128", "https://github.com/transpara-ai/site/pull/130", "https://github.com/transpara-ai/site/pull/132", "https://github.com/transpara-ai/site/pull/144", "https://github.com/transpara-ai/platform/pull/8", "https://github.com/transpara-ai/platform/pull/16", "https://github.com/transpara-ai/platform/pull/18", "https://github.com/transpara-ai/.github/pull/4", "https://github.com/transpara-ai/eventgraph/pull/67", "https://github.com/transpara-ai/eventgraph/pull/68", "https://github.com/transpara-ai/eventgraph/pull/70", "https://github.com/transpara-ai/hive/pull/228", "https://github.com/transpara-ai/hive/pull/229", "https://github.com/transpara-ai/hive/pull/230", "https://github.com/transpara-ai/hive/pull/231", "https://github.com/transpara-ai/hive/pull/233", "https://github.com/transpara-ai/operation/pull/37"},
			...
			CFARRefs:              []string{"docs PR #205 CFAR PASS", "work PR #71/#72/#73 CFAR PASS", "site PR #128/#130/#132/#144 CFAR PASS", "platform PR #8/#16/#18 CFAR PASS", ".github PR #4 CFAR PASS", "eventgraph PR #67/#68/#70 CFAR PASS", "hive PR #228/#229/#230/#231/#233 CFAR PASS", "operation PR #37 CFAR PASS"},
			...
			ProvenanceRefs: []string{
				...
				"https://github.com/transpara-ai/docs/issues/197#issuecomment-4806461882",
			},
		...
		},
		{
			...
			PRRefs:                  []string{"https://github.com/transpara-ai/docs/pull/205", "https://github.com/transpara-ai/site/pull/144", "pending final docs closeout PR"},
			ValidationRefs:          []string{"site#130 validation complete", "site#131 validation complete", "site#133 validation complete", "site#135 validation complete", "site#139 validation complete", "site#143 validation complete by site PR #144", "pending final docs closeout scan"},
			CFARRefs:                []string{"docs PR #205 CFAR PASS", "site PR #130/#132/#134/#136/#138/#140/#142/#144 CFAR PASS", "pending final docs closeout CFAR"},
			AuthorityBoundaryRefs:   []string{"docs#193", "docs#199", "eventgraph#59", "eventgraph#61", "docs#200", "work#59"},
			ResidualRiskRefs:        []string{"docs#201", "docs#202", "docs#203"},
			ProvenanceRefs:          []string{"https://github.com/transpara-ai/docs/pull/205", "https://github.com/transpara-ai/site/pull/144", "merge:874980a7ab6d1b5c6ef3bacfc8c02f1401f00a13", "reviewed_head:2c76e779e51b004db4004f81117cfcb6dd3e3638", "site#144 merge:885d8f14fbcf15c6d5ae1b67d88a3f40a7d9104d", "site#144 reviewed_head:5d62b4d83c942795f49fd423aac29da9d0b897ea", "https://github.com/transpara-ai/site/pull/144#issuecomment-4808318161", "https://github.com/transpara-ai/site/issues/129", "https://github.com/transpara-ai/site/issues/131", "https://github.com/transpara-ai/site/issues/133", "https://github.com/transpara-ai/site/issues/135", "https://github.com/transpara-ai/site/issues/143", "https://github.com/transpara-ai/site/issues/145", "https://github.com/transpara-ai/docs/issues/197", "https://github.com/transpara-ai/docs/issues/197#issuecomment-4806461882", "pending final docs closeout PR"},
