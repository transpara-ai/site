...
func githubCanonicalEvidenceRecords() []OpsGitHubCanonicalEvidenceRecord {
	return []OpsGitHubCanonicalEvidenceRecord{
		...
		},
		{
			...
			Schema:                "GateResult",
			SourceIssueRefs:       []string{"docs#197", "work#61", "work#62", "work#63", "site#127", "site#129", "site#131", "site#133", "platform#5", ".github#3", "eventgraph#63", "eventgraph#62", "hive#220", "hive#221", "hive#222", "hive#223", "operation#34"},
